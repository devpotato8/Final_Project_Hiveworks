...
public class BoardController {
	...
	public String insertBoard(@RequestParam("upFile") MultipartFile[] upFile,
	                          Board b, String boardWriter, String boardType, Model model, HttpSession session) {
	    ...
	    if (upFile != null) {
	        for (MultipartFile mf : upFile) {
	            if (!mf.isEmpty()) {
	                ...
	                String rename = "DNA" + (new SimpleDateFormat("yyyyMMddHHmmssSSS").format(today)) + "_" + randomNum + ext;
	                try {
