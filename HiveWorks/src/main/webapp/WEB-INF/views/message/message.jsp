							...
							<div class="menu-content-wrap">
									...
									<ul class="nav nav-light navbar-nav flex-column">
										<li class="nav-item active">
											<a class="nav-link" href="javascript:void(0);">
												...
												<span class="nav-link-text">My Space</span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="javascript:void(0);">
								...
								<div class="menu-group">
									<ul class="nav nav-light navbar-nav flex-column">
										...
										<li class="nav-item">
											<a class="nav-link" href="javascript:void(0);">
												<span class="nav-icon-wrap"><span class="feather-icon"><i data-feather="video"></i></span></span>
												<span class="nav-link-text">Videos</span>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="javascript:void(0);">
												<span class="nav-icon-wrap"><span class="feather-icon"><i data-feather="play"></i></span></span>
						...
						<div class="fmapp-detail-wrap">
							<header class="fm-header">
								...
								<div class="fm-options-wrap">	
									...
									<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover fmapp-info-toggle" href="#" ><span class="icon"><span class="feather-icon"><i data-feather="info"></i></span></span></a>
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item" href="file-manager-list.html"><span class="feather-icon dropdown-icon"><i data-feather="list"></i></span><span>List View</span></a>
										<a class="dropdown-item active" href="file-manager-grid.html"><span class="feather-icon dropdown-icon"><i data-feather="grid"></i></span><span>Grid View</span></a>
									</div>
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<div class="media fmapp-info-trigger">
																		<div class="media-head me-3">
																			<img src="${path}/resources/img/gallery/mock7.jpg" alt="user" class="d-block img-fluid w-50p">
																		</div>
																		<div class="media-body">
																			<div class="file-name">bruce-mars-fiEG-Pk6ZEZLA</div>
																			<div>png</div>
																		</div>
																	</div>
																</td>
															...
															<tr>
																...
																<td>
																	<div class="avatar-group avatar-group-overlapped">
																		<div class="avatar avatar-rounded" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Danial">
																			<img src="${path}/resources/img/avatar2.jpg" alt="user" class="avatar-img">
																		</div>
																	</div>													
																</td>
															...
															<tr>
																...
																<td>
																	<div class="media fmapp-info-trigger">
																		...
																		<div class="media-body">
																			<div class="file-name">Jampack</div>
																			<div>folder</div>
																		</div>
																	</div>
																</td>
