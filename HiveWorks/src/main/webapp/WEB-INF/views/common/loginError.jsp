								...
								<div class="w-100">
									<div class="row">
										<div class="col-xxl-9 col-xl-8 col-lg-11">
											<h1 class="display-4 fw-bold mb-2">Login Fail!</h1>
											<br>
												<p class="p-lg"><b>로그인에 실패했습니다</b></p>
											<br>
												<p class="p-lg">아이디/비밀번호를 확인해주세요</p>
											<Br>
											<p class="p-sm">이 페이지가 계속되면 관리자에게 문의해주세요</p>
																					
											<a href="${path}/MyLoginPage" class="btn btn-primary mt-4">로그인페이지로</a>
											<Br>
										</div>
									</div>
								</div>
