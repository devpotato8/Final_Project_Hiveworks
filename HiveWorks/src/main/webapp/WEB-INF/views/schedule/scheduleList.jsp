...
<c:set var="path" value="${pageContext.request.contextPath}"/>
  <link rel="icon" href="favicon.ico" type="image/x-icon">
	...
	<!-- Sweetalert2 CSS -->
	<link href="${path}/resources/vendors/@sweetalert2/theme-bootstrap-4/bootstrap-4.min.css" rel="stylesheet" type="text/css">
			
	<!-- Calendar CSS -->
    <link href="${path}/resources/vendors/fullcalendar/main.min.css" rel="stylesheet" type="text/css" />
			...
			<div>
				<div class="drawer-header">
					<div class="drawer-header-action">
						<a href="#" id="edit_event" class="btn btn-sm btn-icon btn-flush-secondary btn-rounded flush-soft-hover"><span class="icon"><span class="feather-icon"><i data-feather="edit-2"></i></span></span></a>
						<a href="#"  id="del_event" class="btn btn-sm btn-icon btn-flush-secondary btn-rounded flush-soft-hover"><span class="icon"><span class="feather-icon"><i data-feather="trash-2"></i></span></span></a>
						<a href="#" class="btn btn-sm btn-icon btn-flush-secondary btn-rounded flush-soft-hover me-2"><span class="icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span></a>
					...
					<div data-simplebar class="nicescroll-bar">
						<div class="drawer-content-wrap">
							...
							<ul class="event-detail">
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="calendar"></i></span></span>
									Aug 18,2020 - Aug 19, 2020
								</li>
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="clock"></i></span></span>
									8:40 AM - 5:40 PM
								</li>
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="map-pin"></i></span></span>
									Oslo, Canada
								</li>
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="check-square"></i></span></span>
									Meetings
								</li>
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="eye"></i></span></span>
									Default Visibility
								</li>
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="user-plus"></i></span></span>
									<div class="d-flex flex-wrap">
										...
										<div class="chip chip-primary user-chip mb-2 me-2">
											<span>
												...
												<span class="chip-text">Charlie</span>
											</span>
										</div>
										<div class="chip chip-primary user-chip mb-2 me-2">
											<span>
								...
								<li>
									<span class="ev-icon-wrap"><span class="feather-icon"><i data-feather="menu"></i></span></span>
					...
					<div data-simplebar class="nicescroll-bar">
						<div class="drawer-content-wrap">
							<div class="event-head mb-4">
								<span class="badge badge-violet badge-indicator badge-indicator-xl flex-shrink-0 me-2"></span>
								<div>
									<div class="event-name" contenteditable="true">Jampack Team Meet</div>
									<div class="form-group mt-2 mb-0">
										<div class="form-check form-check-inline ps-0">
											<div class="form-check">
												<input type="radio" id="event_1" name="eventSelect" class="form-check-input" checked=""	>
							...
							<form>
								...
								<div class="form-group">
									<div class="input-group">
										<span class="input-affix-wrapper">
											<span class="input-prefix"><span class="feather-icon"><i data-feather="clock"></i></span></span>
											<input type="text" class="form-control form-wth-icon input-timepicker" value="8:40 AM - 5:40 PM" >
										</span>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group">
										<span class="input-affix-wrapper">
											<span class="input-prefix"><span class="feather-icon"><i data-feather="map-pin"></i></span></span>
								...
								<div class="form-group">
									<div class="input-group">
										<span class="input-affix-wrapper">
											<span class="input-prefix"><span class="feather-icon"><i data-feather="check-square"></i></span></span>
								...
								<div class="form-group">
									<div class="input-group">
										<span class="input-affix-wrapper">
											<span class="input-prefix"><span class="feather-icon"><i data-feather="eye"></i></span></span>
											<select class="form-select">
								...
								<div class="form-group">
									<div class="d-flex flex-wrap">
										...
										<input type="text" class="form-control border-0 p-0 shadow-none flex-1 mb-2 me-2"/>
									</div>
								</div>
								<div class="form-group">
		...
		<div class="hk-pg-wrapper pb-0">
			...
			<div class="hk-pg-body py-0">
				<div class="calendarapp-wrap">
					<nav class="calendarapp-sidebar">
						<div data-simplebar class="nicescroll-bar">
							<div class="menu-content-wrap">
								<button class="btn btn-primary btn-rounded btn-block mb-4" data-bs-toggle="modal" data-bs-target="#create_new_event">일정등록</button>
								...
								<div class="text-center mt-4">
									<div id="inline_calendar" class="d-inline-block">
										<input class="form-control invisible position-absolute" type="text" name="calendar" value="" />
									</div>
								</div>
								...
								<div class="categories-wrap">
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="customChecksc1" checked="">
										<label class="form-check-label" for="customChecksc1">전체일정보기</label>
									</div>
									<div class="separator separator-light"></div>
									...
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="customChecksc2" checked="">
										<label class="form-check-label" for="customChecksc2" style="
										padding-right: 116px">내일정</label>
										<a href="#" class="btn btn-xs btn-icon btn-rounded btn-light" data-bs-toggle="modal" data-bs-target="#add_new_cat"><span class="icon" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="내일정 공유"><span class="feather-icon"><i data-feather="arrow-right-circle"></i></span></span></a> 
										
									</div>
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="customChecksc3" checked="">
										<label class="form-check-label" for="customChecksc3">내부서일정</label>
									</div>
									<div class="d-flex align-items-center justify-content-between mb-2">
									...
									<div class="separator separator-light"></div>
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="customChecksc4">
										<label class="form-check-label" for="customChecksc4">중요일정</label>
									</div>
									<div class="form-check">
										<input type="checkbox" class="form-check-input" id="customChecksc4">
										<label class="form-check-label" for="customChecksc4">전사일정</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
							<div class="modal-content">
									...
									<form>
										<div class="row gx-3">
											<div class="col-sm-12 form-group">
												<input class="form-control  cal-event-name" type="text" placeholder="일정명을 입력해주세요"/>
											</div>
										</div>
										<div class="row gx-3">
											<div class="col-sm-12 form-group">
								...
								<div class="modal-footer align-items-center">
									...
									<button id="add_event" type="button" class="btn btn-primary fc-addEventButton-button" data-bs-dismiss="modal">등록</button>
								</div>
							</div>
						</div>
					</div>
					...
					<!-- short Event -->
					<div id="create_short_event" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-body">
									<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
										...
										<div class="row gx-3">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<select class="form-control form-select me-20">
...
<%@ include file="/WEB-INF/views/common/footer.jsp"%>
	...
	<script src="${path}/resources/vendors/@fullcalendar/bootstrap5/index.global.min.js"></script>
	...
	<script src="${path}/resources/vendors/sweetalert2/dist/sweetalert2.min.js"></script>
