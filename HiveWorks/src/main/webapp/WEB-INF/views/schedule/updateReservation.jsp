							...
							<div class="" style="display: flex;">
								...
								<div style="width: 50%; display: block;">
									<form action="${path}/schedule/reserveResourceEnd.do"
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="form-label">시작일자</label> <input
														...
														type="text" value="${currentR.calStartDate}"/>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
										...
										<div class="form-group">
										    <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="reminder">
										    <label class="form-check-label" for="flexCheckDefault">알림여부</label>
										</div>
										<button type="button" class="btn btn-secondary">취소</button>
										<button id="add_event" type="submit"
											class="btn btn-primary fc-addEventButton-button">수정</button>
									</form>
									<table class="table">
										<thead>
											<tr>
...
window.onload = function() {
    ...
    var reminderYn = '${currentR.reminderYn}'; // 서버에서 제공하는 값을 사용합니다.

    // reminderYn 값에 따라 체크박스의 체크 상태를 설정합니다.
    if (reminderYn === 'Y') {
